...
rm -rf ./build/*.*
_proc "CSS files" "css" "css" 2 $totalsteps "css"
_proc "JavaScript files" "js" "js" 3 $totalsteps "js"
_proc "inc JavaScript files" "inc" "js" 4 $totalsteps "js"
_proc "i18n JavaScript files" "i18n" "js" 5 $totalsteps "js"
